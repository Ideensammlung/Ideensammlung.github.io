...
Entscheidungsprozess teilnehmen, auf fair Weise zum identischen Ergebnis
...
B. die Kunst sein oder das viel-Geld-verdienen sein.
...
Staat selbst) Petition starten oder sogar direkt ein Konvent auslosen lassen,
das in der Sache berät.
...
* Es können parallele Macht-Strukturen leichter entstehen, da sie mit den
...
* die Bürger haben keine Möglichkeit an Entscheidungen und
...
* Parteien müssen sich nicht an die Versprechen des Wahlkampfs halten. Die
...
* Es ist viel leichter ein Geldsystem, dass der Finanzelite nutzt, durchzusetzen
...
sind geheim. In den meisten Ländern gibt keine Verpflichtung diese zu
...
Wenn man mit versucht mit der Politik schriftlich zu kommunizieren, ist oft
...
Fragen nicht ober nur ausweichend.
...
Das ist vor allem heute besonders einfach, da die Technologie zum Streamen
...
halten, wenn es sich nicht im Krieg befindet. Verhandlungsstrategie in
...
> Die wichtigsten sechs Klassifikationen der empirischen Demokratieforschung
...
der Entscheidungsfindung teilnehmen. Element vieler Demokratie-Modelle
...
Je nachdem, wie man ein politisches System gestaltet, kann es, solange man
Mechanismen hat, die das Diktat der Mehrheit verhindern, zu theoretisch
unendlich-langen Blockaden kommen, welche "Reformstau" könnten. Bei genauerer
...
können zugunsten einer kleinen Gruppe sein und sind daher ein Anreiz zu
manipulieren.
...
Die "aleatorische Demokratie" halt ich aus vielen Gründen für eine sehr gute
...
über ein Thema zu starten. Da die Kombination aus Petition + ausgelostes
...
aleatorischen Demokratie eine Liste an Optionen ausarbeitet, spielen sich diese
...
Ein weiteres, wichtiges Element muss die Möglichkeit von Minderheiten sein,
dass nicht gegen ihre Interessen verstoßen wird. Sie muss also eine
...
beständiges Parlament hat, kann man im Falle eines (oder mehrerer) Vetos ein
neues Konvent einberufen. Dadurch kann Reformstau effektiv verhindert werden,
da sich nicht die gleichen Konstellationen in Konventen herausbilden können.
Das Veto kann sowohl innerhalb eines Konvents angewandt werden (z. B. wenn es
um die Wahl von Arbeitsgruppen innerhalb des Konvents geht) aber auch auf Ebene
...
manipulieren kann. Es ist daher wichtig, dass weiterhin freiwillige
...
restliche Vorgang aber noch erkennbar. Diese Aufnahmen müssen der
...
Ganzen zur Verfügung stehen könnte.
...
verstößt und damit auch nicht Verfassungsfeindlich.
...
Einige Paragrafen aus dem Grundgesetz sollte meiner Meinung nach entweder
...
>
> **Übernommen aus Art 79 GG und erweiter**  
...
> Der einzigen Paragraphen, die aus der jetzigen Verfassung dabei enthalten
...
> (2) Gewalt darf grundsätzlich nur von der Bevölkerung bestimmten
> Autoritäten ausgehen.
> (3) Gewalt darf nur im Gebiet der Bundesrepublik Deutschland ausgeübt
> werden. In internationalen Beziehung muss auf Diplomatie und Wandel durch
> Annäherung zurückgegriffen werden.

Weitere Regeln könnten sein:

> **Die Anzahl an gleichzeitig aktiven Konventsmitglieder ist begrenzt**  
...
250, 500 & 1000, dann wäre das 1,5-fache eine Gesamtmenge von 1500. Dadurch
könnten gleichzeitig ein Konvent mit 1000, einer mit 250, einer
mit 100, einer mit 50 und fünf mit 20 Teilnehmern. Dadurch gibt es nicht zu viel
...
Siehe oben, Kapitel "Transparenz"
...
* Wenn an der Entscheidungsfindung alle Bürger oder sogar Einwohner teilhaben
  ...
  Interesse die Abschaffung des partizipatorischen System ist.
